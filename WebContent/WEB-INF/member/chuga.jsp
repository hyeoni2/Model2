...
<form name = "chugaForm">	
	<table>
		...
		<tr>
			<td>연락처</td>
			<td>
				<input type="text" name="ph1" size="5px">-
				<input type="text" name="ph2" size="5px">-
				<input type="text" name="ph3" size="5px">	
			</td>
		</tr>
		<tr>
		<td rowspan="3">주소 : </td>
...
<script>
	...
	function chuga() {
		...
		if(chugaForm.ph1.value == ""){
			alert('전화번호 첫째자리를 입력해주세요');
			chugaForm.ph1.focus();
			return;
		}
		if(chugaForm.ph2.value == ""){
			alert('전화번호 둘째자리를 입력해주세요');
			chugaForm.ph2.focus();
			return;
		}
		if(chugaForm.ph3.value == ""){
			alert('전화번호 셋째자리를 입력해주세요');
			chugaForm.ph3.focus();
			return;
		}
